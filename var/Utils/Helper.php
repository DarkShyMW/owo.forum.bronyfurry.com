...
class Helper
{
    ...
    public static function removePlugin(string $pluginName)
    {
        try {
            ...
            [$pluginFileName, $className] = Plugin::portal(
                $pluginName,
                __OWO_ROOT_DIR__ . '/' . __OWO_PLUGIN_DIR__
            );
    ...
    public static function replyLink(
        ...
        if (self::options()->commentsThreaded) {
            echo '<a href="#' . $formId . '" rel="nofollow" onclick="return OWOAddCommentReply(\'' .
    ...
    {
        if (self::options()->commentsThreaded) {
            echo '<a href="#' . $formId . '" rel="nofollow" onclick="return OWOCancelCommentReply(\'' .
                $formId . '\');">' . $word . '</a>';
        }
    }
...
var OWOAddCommentReply = function (cid, coid, cfid, style) {
...
var OWOCancelCommentReply = function (cfid) {
    var _cf = document.getElementById(cfid),
