...
/**
 * 包含获取数据支持方法的类.
 * 必须定义__OWO_DB_HOST__, __OWO_DB_PORT__, __OWO_DB_NAME__,
 * __OWO_DB_USER__, __OWO_DB_PASS__, __OWO_DB_CHAR__
 *
 * @package Db
 */
class Db
{
     ...
     * @throws DbException
     */
    public function __construct($adapterName, string $prefix = 'OWO_')
    {
        /** 获取适配器名称 */
        ...
        /** 数据库适配器 */
        $adapterName = '\OWO\Db\Adapter\\' . str_replace('_', '\\', $adapterName);
