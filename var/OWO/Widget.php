...
use OWO\Widget\Helper\EmptyClass;
use OWO\Widget\Request as WidgetRequest;
use OWO\Widget\Response as WidgetResponse;
use OWO\Widget\Terminal;
...
abstract class Widget
{
    ...
    {
        if (Common::nativeClassName(static::class) == 'OWO_Widget') {
            if (isset($alias)) {
