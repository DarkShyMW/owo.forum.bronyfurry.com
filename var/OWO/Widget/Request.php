...
namespace OWO\Widget;

use OWO\Config;
use OWO\Request as HttpRequest;
...
class Request
{
    ...
    private const FILTERS = [
        ...
        'search'  => ['\OWO\Common', 'filterSearchQuery'],
        'xss'     => ['\OWO\Common', 'removeXSS'],
        'url'     => ['\OWO\Common', 'safeUrl'],
        'slug'    => ['\OWO\Common', 'slugName']
    ];
