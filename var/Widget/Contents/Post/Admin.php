...
class Admin extends Contents
{
    ...
    public function execute()
    {
        ...
        if (!$this->user->pass('editor', true)) {
            ...
            if ('on' == $this->request->__OWO_all_posts) {
                Cookie::set('__OWO_all_posts', 'on');
            } else {
                if ('off' == $this->request->__OWO_all_posts) {
                    Cookie::set('__OWO_all_posts', 'off');
                }

                if ('on' != Cookie::get('__OWO_all_posts')) {
