...
class User extends Users
{
    ...
    public function hasLogin(): ?bool
    {
        if (null !== $this->hasLogin) {
            ...
            $cookieUid = Cookie::get('__OWO_uid');
            if (null !== $cookieUid) {
                /** 验证登陆 */
                ...
                $cookieAuthCode = Cookie::get('__OWO_authCode');
    ...
    public function logout()
    {
        ...
        Cookie::delete('__OWO_uid');
        Cookie::delete('__OWO_authCode');
    }
    ...
    public function commitLogin(&$user, int $expire = 0)
    {
        ...
        Cookie::set('__OWO_uid', $user['uid'], $expire);
        Cookie::set('__OWO_authCode', Common::hash($authCode), $expire);
    ...
    public function pass(string $group, bool $return = false): bool
    {
        if ($this->hasLogin()) {
            ...
            if ($return) {
                ...
                //防止循环重定向
                $this->response->redirect(defined('__OWO_ADMIN__') ? $this->options->loginUrl .
