...
class Upload extends Contents implements ActionInterface
{
    ...
    public static function deleteHandle(array $content): bool
    {
        ...
        return @unlink(__OWO_ROOT_DIR__ . '/' . $content['attachment']->path);
    }
    ...
    public static function attachmentHandle(array $content): string
    {
        ...
        return Common::url(
            ...
            defined('__OWO_UPLOAD_URL__') ? __OWO_UPLOAD_URL__ : $options->siteUrl
        );
    }
    ...
    public static function attachmentDataHandle(array $content): string
    {
        ...
        return file_get_contents(
            Common::url(
                $content['attachment']->path,
                defined('__OWO_UPLOAD_ROOT_DIR__') ? __OWO_UPLOAD_ROOT_DIR__ : __OWO_ROOT_DIR__
            )
        );
    }
    ...
    public static function uploadHandle(array $file)
    {
        ...
        $date = new Date();
        $path = Common::url(
            defined('__OWO_UPLOAD_DIR__') ? __OWO_UPLOAD_DIR__ : self::UPLOAD_DIR,
            defined('__OWO_UPLOAD_ROOT_DIR__') ? __OWO_UPLOAD_ROOT_DIR__ : __OWO_ROOT_DIR__
        ...
        return [
            'name' => $file['name'],
            'path' => (defined('__OWO_UPLOAD_DIR__') ? __OWO_UPLOAD_DIR__ : self::UPLOAD_DIR)
