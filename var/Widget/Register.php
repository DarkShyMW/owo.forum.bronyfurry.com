...
class Register extends Users implements ActionInterface
{
    ...
    public function action()
    {
        ...
        if ($error = $validator->run($this->request->from('name', 'password', 'mail', 'confirm'))) {
            Cookie::set('__OWO_remember_name', $this->request->name);
            Cookie::set('__OWO_remember_mail', $this->request->mail);
        ...
        Cookie::delete('__OWO_first_run');
        Cookie::delete('__OWO_remember_name');
        Cookie::delete('__OWO_remember_mail');
