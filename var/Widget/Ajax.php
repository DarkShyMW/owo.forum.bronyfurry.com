...
class Ajax extends BaseOptions implements ActionInterface
{
    ...
    public function checkVersion()
    {
        ...
        if ($client) {
            ...
            try {
                $client->send('http://OWO.org/version.json');
     ...
     *
     * @throws Exception
     * @throws Client\Exception|\OWO\Db\Exception
     */
     ...
     * 自定义编辑器大小
     *
     * @throws \OWO\Db\Exception|Exception
     */
