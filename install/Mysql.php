...
<ul class="owo-option">
    <li>
        <label class="owo-label" for="dbHost"><?php _e('数据库地址'); ?></label>
...
<ul class="owo-option">
    <li>
        <label class="owo-label" for="dbUser"><?php _e('数据库用户名'); ?></label>
...
<ul class="owo-option">
    <li>
        <label class="owo-label" for="dbPassword"><?php _e('数据库密码'); ?></label>
        <input type="password" class="text" name="dbPassword" id="dbPassword" value="" />
    </li>
</ul>
<ul class="owo-option">
    <li>
        <label class="owo-label" for="dbDatabase"><?php _e('数据库名'); ?></label>
...
<details>
    ...
    <ul class="owo-option">
        <li>
            <label class="owo-label" for="dbPort"><?php _e('数据库端口'); ?></label>
    ...
    <ul class="owo-option">
        <li>
            <label class="owo-label" for="dbCharset"><?php _e('数据库编码'); ?></label>
    ...
    <ul class="owo-option">
        <li>
            <label class="owo-label" for="dbEngine"><?php _e('数据库引擎'); ?></label>
