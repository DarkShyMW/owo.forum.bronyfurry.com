                            ...
                            <?php while ($users->next()): ?>
                                <tr id="user-<?php $users->uid(); ?>">
                                    ...
                                    <td class="kit-hidden-mb"><a
                                            href="<?php $options->adminUrl('manage-posts.php?__OWO_all_posts=off&uid=' . $users->uid); ?>"
                                            class="balloon-button left size-<?php echo \OWO\Common::splitByCount($users->postsNum, 1, 10, 20, 50, 100); ?>"><?php $users->postsNum(); ?></a>
                                    </td>
                                    <td>
