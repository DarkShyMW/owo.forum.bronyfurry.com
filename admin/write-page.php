                ...
                <div class="col-mb-12 col-tb-9" role="main">
                    <?php if ($page->draft): ?>
                        <?php if ($page->draft['cid'] != $page->cid): ?>
                            <?php $pageModifyDate = new \OWO\Date($page->draft['modified']); ?>
                            <cite
                    ...
                    <?php $permalink = \OWO\Common::url($options->routingTable['page']['url'], $options->index);
                    ...
                    <?php \OWO\Plugin::factory('admin/write-page.php')->content($page); ?>
                </div>
                <div id="edit-secondary" class="col-mb-12 col-tb-3" role="complementary">
                    ...
                    <div id="tab-advance" class="tab-content">
                        ...
                        <section class="OWO-post-option">
                            <label for="order" class="OWO-label"><?php _e('页面顺序'); ?></label>
                        ...
                        <section class="OWO-post-option">
                            <label for="template" class="OWO-label"><?php _e('自定义模板'); ?></label>
                            <p>
                        ...
                        <?php \OWO\Plugin::factory('admin/write-page.php')->option($page); ?>
                        ...
                        <div id="advance-panel">
                            ...
                            <?php \OWO\Plugin::factory('admin/write-page.php')->advanceOption($page); ?>
                        </div>
                        <?php if ($page->have()): ?>
                            <?php $modified = new \OWO\Date($page->modified); ?>
                            <section class="OWO-post-option">
                                <p class="description">
                                    <br>&mdash;<br>
                                    <?php _e('本页面由 <a href="%s">%s</a> 创建',
                                        \OWO\Common::url('manage-pages.php?uid=' . $page->author->uid, $options->adminUrl), $page->author->screenName); ?>
                                    <br>
...
\OWO\Plugin::factory('admin/write-page.php')->trigger($plugged)->richEditor($page);
if (!$plugged) {
...
\OWO\Plugin::factory('admin/write-page.php')->bottom($page);
include 'footer.php';
?>
