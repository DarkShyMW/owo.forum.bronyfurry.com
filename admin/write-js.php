...
<?php \OWO\Plugin::factory('admin/write-js.php')->write(); ?>
...
$(document).ready(function() {
    ...
    // text 自动拉伸
    OWO.editorResize('text', '<?php $security->index('/action/ajax?do=editorResize'); ?>');
...
<?php endif; ?>
    ...
    $('#edit-secondary .OWO-option-tabs li').click(function() {
        $('#edit-secondary .OWO-option-tabs li').removeClass('active');
