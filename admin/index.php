...
?>
<div class="main">
    <div class="container OWO-dashboard">
            ...
            <div class="col-mb-12 welcome-board" role="main">
                ...
                <ul id="start-link" class="clearfix">
                    <?php if ($user->pass('contributor', true)): ?>
                        ...
                        <?php if ($user->pass('editor', true) && 'on' == $request->get('__OWO_all_comments') && $stat->waitingCommentsNum > 0): ?>
                            <li>
                        ...
                        <?php endif; ?>
                        <?php if ($user->pass('editor', true) && 'on' == $request->get('__OWO_all_comments') && $stat->spamCommentsNum > 0): ?>
                            <li>
...
<script>
    $(document).ready(function () {
        var ul = $('#OWO-message ul'), cache = window.sessionStorage,
        ...
        function applyUpdate(update) {
            if (update.available) {
                $('<div class="update-check message error"><p>'
                    ...
                    .insertAfter('.OWO-page-title').effect('highlight');
            }
        }
