            ...
            <div class="col-mb-12 col-tb-8" role="main">
                <?php if ($attachment->attachment->isImage): ?>
                    <p><img src="<?php $attachment->attachment->url(); ?>"
                            alt="<?php $attachment->attachment->name(); ?>" class="OWO-attachment-photo"/></p>
                <?php endif; ?>

                <p>
                    <?php $mime = \OWO\Common::mimeIconType($attachment->attachment->mime); ?>
