...
<div class="main">
    <div class="body container">
        ...
        <div class="row OWO-page-main" role="main">
            <div class="col-mb-12">
                <ul class="OWO-option-tabs fix-tabs clearfix">
            ...
            <div class="OWO-edit-theme">
                <div class="col-mb-12 col-tb-8 col-9 content">
                    <form method="post" name="theme" id="theme"
                        ...
                        <p class="OWO-option OWO-option-submit">
...
\OWO\Plugin::factory('admin/theme-editor.php')->bottom($files);
include 'footer.php';
?>
