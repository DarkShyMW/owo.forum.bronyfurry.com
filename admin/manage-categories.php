...
<div class="main">
    <div class="body container">
        ...
        <div class="row OWO-page-main manage-metas">
                ...
                <form method="post" name="manage_categories" class="operate-form">
                    ...
                    <div class="OWO-table-wrap">
                        <table class="OWO-list-table">
                                ...
                                <?php while ($categories->next()): ?>
                                    <tr id="mid-<?php $categories->theId(); ?>">
                                        ...
                                        <td class="kit-hidden-mb"><a
                                                class="balloon-button left size-<?php echo \OWO\Common::splitByCount($categories->count, 1, 10, 20, 50, 100); ?>"
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="OWO-list-table-title"><?php _e('没有任何分类'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
...
<script type="text/javascript">
    (function () {
        $(document).ready(function () {
            ...
            $('.OWO-mini-panel').effect('highlight', '#AACB36');
            <?php endif; ?>
        });
    })();
</script>
