...
$(document).ready(function () {
    ...
    <?php \OWO\Plugin::factory('admin/editor-js.php')->markdownEditor($content); ?>
    ...
    var th = textarea.height(), ph = preview.height(),
        uploadBtn = $('<button type="button" id="btn-fullscreen-upload" class="btn btn-link">'
            ...
            .click(function() {
                $('a', $('.OWO-option-tabs li').not('.active')).trigger('click');
                return false;
            });

    $('.OWO-option-tabs li').click(function () {
    ...
    function initMarkdown() {
        ...
        OWO.insertFileToEditor = function (file, url, isImage) {
        ...
        OWO.uploadComplete = function (file) {
            OWO.insertFileToEditor(file.title, file.url, file.isImage);
        };
        ...
        textarea.pastableTextarea().on('pasteImage', function (e, data) {
            ...
            OWO.uploadFile(new File([data.blob], name), name);
        });
    }
