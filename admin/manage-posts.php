...
$isAllPosts = ('on' == $request->get('__OWO_all_posts') || 'on' == \OWO\Cookie::get('__OWO_all_posts'));
?>
<div class="main">
                    ...
                    <ul class="OWO-option-tabs right">
                        <?php if ($user->pass('editor', true) && !isset($request->uid)): ?>
                            <li class="<?php if ($isAllPosts): ?> current<?php endif; ?>"><a
                                    href="<?php echo $request->makeUriByRequest('__OWO_all_posts=on&page=1'); ?>"><?php _e('所有'); ?></a>
                            </li>
                            <li class="<?php if (!$isAllPosts): ?> current<?php endif; ?>"><a
                                    href="<?php echo $request->makeUriByRequest('__OWO_all_posts=off&page=1'); ?>"><?php _e('我的'); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                    ...
                    <form method="get">
                        <div class="operate">
                            <label><i class="sr-only"><?php _e('全选'); ?></i><input type="checkbox"
                                                                                   class="OWO-table-select-all"/></label>
                    ...
                    <div class="OWO-table-wrap">
                        <table class="OWO-list-table">
                            ...
                            <?php if ($posts->have()): ?>
                                <?php while ($posts->next()): ?>
                                    <tr id="<?php $posts->theId(); ?>">
                                        ...
                                        <td class="kit-hidden-mb"><a
                                                ...
                                                class="balloon-button size-<?php echo \OWO\Common::splitByCount($posts->commentsNum, 1, 10, 20, 50, 100); ?>"
                                        ...
                                        <td class="kit-hidden-mb"><a
                                                href="<?php $options->adminUrl('manage-posts.php?__OWO_all_posts=off&uid=' . $posts->author->uid); ?>"><?php $posts->author(); ?></a>
                                        </td>
                                ...
                                <?php $modifyDate = new \OWO\Date($posts->modified); ?>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="OWO-list-table-title"><?php _e('没有任何文章'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
