...
<?php
if (isset($post) && $post instanceof \OWO\Widget && $post->have()) {
    $fileParentContent = $post;
} elseif (isset($page) && $page instanceof \OWO\Widget && $page->have()) {
...
$(document).ready(function() {
        ...
        uploader = new plupload.Uploader({
            ...
            init            :   {
                ...
                UploadComplete  :   function () {
                    if (completeFile) {
                        OWO.uploadComplete(completeFile);
                    }
                },
    ...
    OWO.uploadFile = function (file, name) {
        if (!uploader) {
    ...
    function attachInsertEvent (el) {
        $('.insert', el).click(function () {
            ...
            OWO.insertFileToEditor(t.text(), p.data('url'), p.data('image'));
            return false;
        });
    }
