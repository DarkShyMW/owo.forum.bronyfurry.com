                    ...
                    <div class="OWO-table-wrap">
                        <table class="OWO-list-table">
                            ...
                            <?php if ($pages->have()): ?>
                                <?php while ($pages->next()): ?>
                                    <tr id="<?php $pages->theId(); ?>">
                                        ...
                                        <td class="kit-hidden-mb"><a
                                                ...
                                                class="balloon-button size-<?php echo \OWO\Common::splitByCount($pages->commentsNum, 1, 10, 20, 50, 100); ?>"
                                ...
                                <?php $modifyDate = new \OWO\Date($pages->modified); ?>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="OWO-list-table-title"><?php _e('没有任何页面'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
    ...
    <script type="text/javascript">
        (function () {
            $(document).ready(function () {
                var table = $('.OWO-list-table').tableDnD({
                    onDrop: function () {
                        var ids = [];
