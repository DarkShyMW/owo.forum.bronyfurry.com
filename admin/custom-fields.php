...
<section id="custom-field"
         class="OWO-post-option<?php if (empty($defaultFields) && empty($fields)): ?> fold<?php endif; ?>">
    <label id="custom-field-expand" class="OWO-label"><a href="##"><i
                class="i-caret-right"></i> <?php _e('自定义字段'); ?></a></label>
    <table class="OWO-list-table mono">
        <colgroup>
            <col width="25%"/>
            <col width="10%"/>
            <col width="55%"/>
    ...
    <div class="description clearfix">
        ...
        <?php _e('自定义字段可以扩展你的模板功能, 使用方法参见 <a href="http://docs.OWO.org/help/custom-fields">帮助文档</a>'); ?>
    </div>
</section>
